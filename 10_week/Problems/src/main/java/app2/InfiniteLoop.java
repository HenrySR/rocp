...
public class InfiniteLoop {
	...
	while (true) {	
	 ...
	 //   student.put("Middle Initial", middleInitial);
	...
	//  System.out.println(String.format("The students %s is %s.", attribute, value));
	//   });
	...
	students.forEach(allStudent->allStudent.forEach((attribute, value) -> {;
	   System.out.println(String.format("The students %s is %s.", attribute, value));
	   }));
